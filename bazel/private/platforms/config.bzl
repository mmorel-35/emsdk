...
This module contains all platform-specific configuration data, organized using
the DRY (Don't Repeat Yourself) principle with helper functions to minimize duplication.
"""
